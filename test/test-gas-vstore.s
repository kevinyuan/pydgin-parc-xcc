...
test:
        ...
        li        $t2, 4             # t4 = stride amount
        swst.v    $vt0, $t1, $t2     # not a very tough test....
        shst.v    $vt0, $t1, $t2     # not a very tough test....
        sbst.v    $vt0, $t1, $t2     # not a very tough test....

        swseg.v      $vt0, $t1, 0x4          # not a very tough test....
        shseg.v      $vt0, $t1, 0x4          # not a very tough test....
        sbseg.v      $vt0, $t1, 0x4          # not a very tough test....
        
        swsegst.v    $vt0, $t1, 0x4, $t2     # not a very tough test....
        shsegst.v    $vt0, $t1, 0x4, $t2     # not a very tough test....
        sbsegst.v    $vt0, $t1, 0x4, $t2     # not a very tough test....
