...
/* This is more than just a header include guard so this should not be
   changed to say TC_MIPS_MAVEN. For example, obj-coff.h, obj-ecoff.c,
   and obj-elf.h, obj-elf.c all check to see if TC_MIPS is defined. */
